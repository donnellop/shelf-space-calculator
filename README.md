...
- The script was automatically generated by ChatGPT, further developed in Colab and manually tweaked for accuracy and to reflect the conceptualisation of the acquistion history-based space allocation policy by donnellop
```

You can copy and paste this into a `README.md` file in your GitHub repository. If there are any additional details you'd like to include, please let me know!
